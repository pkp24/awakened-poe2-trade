...
export async function initConfig () {
  ...
  try {
    ...
    // TODO
    // dialog.showErrorBox(
    //   'Awakened PoE2 Trade - Incompatible configuration',
    //   // ----------------------
    //   'You are trying to use an older version of Awakened PoE2 Trade with a newer incompatible configuration file.\n' +
